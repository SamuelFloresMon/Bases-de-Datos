...
async function main() {
    ...
    const database: string = 'Restaurante';
    const collection: string = 'Recetas';

    // Creates a default interface menu structure  
    interface Menu {
        [key: number]: string;
    }
    ...
    */
    ...
    /*
        ...
        Returns -> void
    */
    async function closeConnection(client: any) {
        await client.close();
    }
    ...
    /*
        ...
        Returns -> void
        */
    async function restaurante(client: any) {
        try {
            // Main menu 
    ...
    /*
        ...
        Returns -> void 
    */
    async function find(client: any) {
        ...
        switch (choice) {
            ...
            case 4:
                ...
                const dificultad: number = parseInt(readline.question(`Escribe el numero de la dificultad: `));
                result = await myCollection.find({ dificultad: dificultades[dificultad] }).toArray();
                break;

            case 5:
                const receta: string = readline.question(`Escribe el nombre de la receta a buscar: `);
    ...
    /*
        ...
        Returns -> void 
    */
    async function update(client: any) {
    ...
    /*
        ...
        Returns -> void 
    */
    async function deleteDocument(client: any) {
